  ...
  render() {
    return (
      <Tooltip content={this.props.name} placement="bottom">
        <a
          href={this.getUrl(this.props.contestId, this.props.index)}
          target="_blank"
        ...
        >
          <button
            className={
              ...
              ' text-white shadow-md text-xl focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-lg transition-colors'
            }
          >
            {this.props.index}
          </button>
